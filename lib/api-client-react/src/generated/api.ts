...
export const updateReservationStatus = async (id: number,
    statusUpdate: StatusUpdate, options?: RequestInit): Promise<Reservation> => {
...
export const getUpdateReservationStatusMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateReservationStatus>>, TError,{id: number;data: BodyType<StatusUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateReservationStatus>>, TError,{id: number;data: BodyType<StatusUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateReservationStatus>>, {id: number;data: BodyType<StatusUpdate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateReservationStatusMutationBody = BodyType<StatusUpdate>
    export type UpdateReservationStatusMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Update reservation status
 */
export const useUpdateReservationStatus = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateReservationStatus>>, TError,{id: number;data: BodyType<StatusUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const getPricing = async ( options?: RequestInit): Promise<PricingInfo> => {

  return customFetch<PricingInfo>(getGetPricingUrl(),
  {
    ...options,
    method: 'GET'
